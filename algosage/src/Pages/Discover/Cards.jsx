  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
      <div className="relative rounded-lg border border-[#272C31] bg-light/10 p-5">
        ...
        />
        <h1 className="text-xl p-1 text-white/80">Stake ALGOSAGE</h1>
        <p className="text-sm text-light p-1 pb-6">
          Stake ALGOSAGE and receives fee distributions from protocol <br />
          revenue
        </p>
