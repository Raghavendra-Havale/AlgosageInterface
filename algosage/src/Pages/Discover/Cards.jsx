  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
      <div className="relative rounded-lg border border-[#272C31] bg-light/10 p-5">
        ...
        <button className="font-medium flex items-center justify-center bg-light/20 text-white-100 enabled:hover:bg-light/40 px-3 py-[11px] text-sm rounded-lg gap-x-2">
          Stake GAMMA →{" "}
        </button>
      </div>
